...
namespace Dependencies
{
    ...
    public class Account
    {
        ...
        [DataMember]
        public bool Client_card_edit, discount_edit, price_edit, receipt_edit, inventory_edit, expenses_add, users_edit, settings_edit, personnel_edit, openclose_edit, sell_edit;
        [DataMember]
        ...
        {
            this.Pwd = MD5Encryption.Encrypt(pwd, "PlancksoftPOS");
        }
