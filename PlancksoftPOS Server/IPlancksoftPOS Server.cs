...
namespace PlancksoftPOS_Server
{
    ...
    public interface IPlancksoftPOS_Server
    {
        ...
        [OperationContract]
        Tuple<List<Bill>, DataTable> RetrieveVendorBills(int ClientID);
        [OperationContract]
        DataTable RetrieveTaxZReport(string StartDate, string EndDate);
        [OperationContract]
        Tuple<List<Bill>, DataTable> RetrieveBills();     
        [OperationContract]
        Tuple<List<Bill>, DataTable> RetrieveUnprintedBills(string MachineName);     
        [OperationContract]
        Tuple<List<Bill>, DataTable> RetrieveReprintedBills(string MachineName);   
        [OperationContract]
